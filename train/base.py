...
from utils.Unc import UncertaintyVisualizer
...
class TrainBase(object):
    ...
    def __init__(self,
        ...
        # # 添加不确定性可视化器初始化
        # if hasattr(self.args, 'uncertainty_collect_interval'):
        #     self.uncertainty_visualizer = UncertaintyVisualizer(self.args, self.logger, self.rank)
        # else:
        #     self.uncertainty_visualizer = None
        ...
        self.best_epoch_i_c = 0
        self.best_epoch_t_c = 0
